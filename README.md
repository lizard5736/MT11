...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/версия-0.1-FFB020" alt="Версия 0.1">
</p>
...
Grip растёт по этапам. Дальше — звук и мониторинг, окна и ввод, захват экрана и медиа, управление приложениями. Подробный план с тем, что переносится с macOS, что адаптируется под Windows и от чего отказались, — в [docs/ROADMAP.md](docs/ROADMAP.md).
